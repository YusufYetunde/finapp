import { UPLIFT_DELIVERY_DATA } from "../../data/data"
  ...
  return (
    <section className="lg:py-[65px] py-10 px-4">
      <div className="max-w-[1200px] mx-auto">
        <h3 className="text-center text-black font-montserrat lg:text-3xl md:text-2xl text-xl font-semibold">
          How we Work
        </h3>
          ...
          {UPLIFT_DELIVERY_DATA?.map(
            ({ id, title, icon, description }, index) => {
              return (
                <motion.div
                  key={id}
                  className="  rounded-3xl p-[3px] md:min-h-[315px] min-h-auto"
                ...
                >
                  <div className="rounded-3xl bg-jet flex flex-col items-start h-full lg:p-8 md:p-6 p-4">
                    ...
                    <h4 className="lg:text-xl md:text-lg text-base text-black font-montserrat font-semibold mt-5 mb-4">
                      {title}
                    </h4>
                    <p className="lg:text-base text-sm font-source-sans text-black">
                      {description}
                    </p>
                  </div>
                </motion.div>
